...
class RenderMusicXML
  ...
  def render_score(beats_per_bar, ticks_per_beat, score)
    mxml = score.to_mxml(beats_per_bar, ticks_per_beat,
                         ...
                         parts: { vln1: { name: 'Strings 1', abbreviation: 'vln1', clefs: { g: 2 } },
                                  vln2: { name: 'Strings 2', abbreviation: 'vln2', clefs: { g: 2 } },
                                  vln3: { name: 'Strings 3', abbreviation: 'vln3', clefs: { g: 2 } },
                                  vln4: { name: 'Strings 4', abbreviation: 'vln4', clefs: { g: 2 } },
                                  vln5: { name: 'Strings 5', abbreviation: 'vln5', clefs: { g: 2 } },
                                  vln6: { name: 'Strings 6', abbreviation: 'vln6', clefs: { g: 2 } },
                                  vln7: { name: 'Strings 7', abbreviation: 'vln7', clefs: { g: 2 } },
                                  vln8: { name: 'Strings 8', abbreviation: 'vln8', clefs: { g: 2 } },
